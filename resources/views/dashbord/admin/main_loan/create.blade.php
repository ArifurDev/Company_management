                    ...
                    <div class="row ">
                          ...
                          <div class="card">
                            <div class="card-body">
                              ...
                              @endforeach
                             @endif
                              <form class="forms-sample" action="{{ route('mainloan.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                  <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Name</label>
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control text-light" id="exampleInputUsername2" placeholder="Enter Name" name="name">
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Email</label>
                                  <div class="col-sm-9">
                                    <input type="email" class="form-control text-light" id="exampleInputEmail2" placeholder="Enter Email" name="email">
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputMobile" class="col-sm-3 col-form-label">Phone</label>
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control text-light" id="exampleInputMobile" placeholder="Enter Phone number" name="phone">
                                  </div>
                                </div>
                                <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                      <input type="number" class="form-control text-light" id="installment" placeholder="Enter Installment" name="installment" min="1">
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="form-group ">
                                    <img  style="width: 70px; height: 70px; border-radius: 50%; border: 2px solid gray" src="" id="image" ><br>
