                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-sample"action="{{ route('admininfo.store') }}"  method="POST">
                                    @csrf
                                    <p class="card-description"> Admin information </p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"class="form-control text-light" name="card_holder_name" placeholder="Card Holder Name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control text-light" name="card_number" placeholder="Card Number">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"class="form-control text-light" name="currency" placeholder="Currency">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="date" class="form-control text-light" name="expairy_date" placeholder="Expairy Date">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"class="form-control text-light" name="bank_account_number"  placeholder="Bank Account Number">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
