            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-xs-12 bg-dark">
                        ...
                        <table summary="This table shows how to create responsive tables using Datatables' extended functionality" class="table table-bordered  dt-responsive">
                          <thead>
                            <tr>
                          ...
                          <tbody>
                            ...
                            <tr>
                               ...
                               <td >
                                ...
                                <form action="{{ route('empolyeeinfo.destroy',$info->id) }}" method="post"><br>
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-outline-danger btn-fw">Delete</button>
                                </form>
