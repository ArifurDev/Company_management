<div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
 ...
 <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('dashbord/assets') }}/images/logoal-suada-logo.png" alt="logo" /></a>
 <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="{{ asset('dashbord/assets') }}/images/logoal-suada-logo.png" alt="logo" /></a>
  </div>
