                            ...
                            <div class="card">
                              ...
                              <div class="card-body">
                                <h4 class="card-title">Empolyees Reports</h4>
                                 <p class="card-description">Empolyee : {{ $empolyee_count }}</p>
                                 <p class="card-description">Company : {{ $com_name }}</p>
                                <div class="table-responsive">
                                  <table class="table table-dark">
                                    ...
                                    <tbody class="alldata">
                                        ...
                                        @foreach ($empolyeereport as $empolyee)
                                        <tr>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-dark">
                                      ...
                                      <tbody>
                                          ...
                                          @foreach ($com_site_reports as $info)
                                          <tr>
